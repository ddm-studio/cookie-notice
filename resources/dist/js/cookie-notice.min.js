...
var CookieCover = /*#__PURE__*/function () {
  ...
  function CookieCover(instance) {
    ...
    this._covers.forEach(function (cover) {
      ...
      if (_this._instance.hasConsent(cover.dataset.classes)) {
        return;
      }

      var cover_button = cover.querySelector('#ddmcc-button-accept'); // Stop initialization if the button isn't present
